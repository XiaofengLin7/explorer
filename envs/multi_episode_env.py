...
class MultiEpisodeEnv(BaseEnv):
    ...
    def from_dict(info: dict) -> "MultiEpisodeEnv":
        ...
        reflection_prompt = info.get("reflection_prompt", "Please reflect on the previous episode. Analyze what went wrong if you failed, or what worked well if you succeeded.")
