...
EXPERIMENT_NAME="maze-multi-episode-env-${MODEL_NAME}"
...
python scripts/train_gem_multi_episode_env.py \
    ...
    +rllm.env.env_args.inner_env_class=envs.maze_env_adapter.MazeEnvAdapter \
    ...
    +rllm.env.env_args.inner_env_kwargs.env_kwargs.shapes="[[5,5],[6,6],[5,6],[5,7]]" \
