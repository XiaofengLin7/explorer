...
# SDK trace storage path
SDK_STORE_PATH="${HOME}/rllm-traces-gem.db"
echo "SDK Store path: ${SDK_STORE_PATH}"

python scripts/train_gem_multi_episode_sdk.py \
    ...
    trainer.experiment_name='gem-guess-hard-multi-episode-sdk-1.7b' \
    ...
    +rllm.sdk.proxy.model_name=$MODEL_PATH \
    rllm.sdk.store.path="${SDK_STORE_PATH}" \
    "$@"
